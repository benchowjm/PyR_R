...
Attributes store important information about objects. The three most important types of attributes are names, class and dimension. The `str` and `summary` functions are useful for seeing a quick snapshot of your object. A more advanced introduction to R objects is provided by Hadley Wickham [here](http://adv-r.had.co.nz/Data-structures.html).
